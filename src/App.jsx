...
function Splash({ onDone }) {
  ...
  return <div className="brand-splash" aria-label="Vemparajugari Vantillu"><div className="splash-ornament">✦</div><BrandMark /><div className="splash-line" />{clipAvailable && <video className="brand-intro-clip" src={INTRO_CLIP_PATH} autoPlay muted playsInline preload="metadata" onError={() => setClipAvailable(false)} aria-hidden="true" /> }<p>VEMPRAJUGARI VANTILLU</p></div>;
}
...
function ContactPage({ onBack }) { return <section className="info-page"><header className="app-header"><button className="icon-button" onClick={onBack} type="button" aria-label="Back">←</button><BrandMark compact /><span /></header><div className="info-card"><p className="eyebrow">VEMPRAJUGARI VANTILLU</p><h1>సంప్రదించండి</h1><span className="info-en">CONTACT</span><div className="contact-actions"><a href="tel:+919949211191">99492 11191</a><a href="tel:+919798045678">97980 45678</a></div></div></section>; }
